...
SEARCH_PROMPT = get_prompt_builder("./prompts/config.yaml").build_prompt_template(
    "./prompts/google_search_worker.yml"
)
...
def google_search_tool(query: str) -> dict:
    ...
    return {"answer": f"Here are the top 3 results for: {query}", "results": output}
